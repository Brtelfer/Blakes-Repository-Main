async function setTexts(slidenumber) {
    ...
    const url = 'https://raw.githubusercontent.com/Brtelfer/Brtelfer.github.io/refs/heads/main/Data/L28.json';
    let texts;
    ...
    const durationVariables = [
        "UserIncorrect2",	"StudentGood",	"StudentBad1",	"StudentBad2",	"StudentIncorrect1",	"StudentIncorrect2",	"UserCorrect",	"UserIncorrect1", "NegativeFeedback", "PositiveFeedback"
    ];
