async function setTexts(slidenumber) {
    ...
    const url = 'https://raw.githubusercontent.com/Brtelfer/Brtelfer.github.io/refs/heads/main/Data/L15.json';
    let texts;
    ...
    const durationVariables = [
        "UserCorrect",	"UserIncorrect1",	"BlankPrompt",	"UserIncorrect2",	"StudentGood",	"StudentBad1",	"StudentBad2",	"StudentIncorrect1",	"StudentIncorrect2",	"StudentGoodFirst",	"StudentBad1First",	"StudentBad2First",	"StudentIncorrect1First",	"StudentIncorrect2First",	"StudentGoodSecond",	"StudentBad1Second",	"StudentBad2Second",	"StudentIncorrect1Second",	"StudentIncorrect2Second", "PositiveFeedback", "NegativeFeedback"
    ];
