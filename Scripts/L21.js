async function setTexts(slidenumber) {
    ...
    const url = 'https://raw.githubusercontent.com/Brtelfer/Brtelfer.github.io/refs/heads/main/Data/L21.json';
    let texts;
    ...
    const durationVariables = [
        "Correct",	"IncorrectPrompt",	"AskStudent",	"StudentSecondBad1",	"StudentSecondBad2",	"StudentSecondGood",	"StudentUnderstand",	"AskUser",	"StudentFirstBad1",	"StudentFirstBad2",	"StudentFirstGood",	"BlankPrompt"
    ];
