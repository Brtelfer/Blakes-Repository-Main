function setTexts(slidenumber) {
    ...
    const texts = {
        ...
        Quiz1Option1: ["cleaner","responsible"],
        Quiz1Option2: ["cleanliness","irresponsible"],
        Quiz1Option3: ["unclean","responsibility"],
        Quiz1QuestionPrompt: ["The worker was in charge of the room's __________.","Who is __________ for serving this customer?"],
