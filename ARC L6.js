...
var Choice1Texts = [
    ...
    "A solid rock that is known to support life",
    "To sink into water",
    "A plant such as a grain that is grown in large amounts",
    "To build on something",
    "Unimportant thing that is not needed",
    "Finished",
    "It is not good or regular",
    "To have a bulging center",
    "A round root that some plants grow from",
    "Of enormous size",
    "Easy to recognize because it is different from other things",
    "Happening every hour",
    "Planets and moons",
    "An organization of objects",
    "To have an effect on each other",
    "Two things begin to circle each other",
    "An object that increases in size",
    "Things that happen quickly",
    "Very common",
    "To discover the meaning of something",
    "Something that is intentionally done",
    "Something that happens to stars",
...
var Choice2Texts = [
    ...
    "Relating to other planets and not Earth",
    "A deceased thing that is very small",
    "To float in the air",
    ...
    "To be shaped like a pinwheel",
    "To look larger and rounder or fuller than normal",
    "Small amounts of material",
    "The length of space between two things",
    "Not curved or bent",
    "Empty space that is available to use",
    "Someone who works with you",
    "Can be used in the same way",
    "Something that is not important or large",
    "When gravity has no effect",
    "Difficult to believe",
    "To end something",
    "To do something with a particular purpose",
    "A galaxy studied for a particular reason",
    "To damage something very badly",
    "Can be used easily",
    "Extremely small",
    "Gaining knowledge or a new skill",
...
var Choice3Texts = [
    ...
    "Relating to asteroids in space",
    "A living thing",
    "To grow or develop",
    "Land that does not support life or crops",
    "To have nothing",
    "One of the things that makes the whole of something else",
    "Complete",
    "To cover a large area in an untidy way",
    "To be made or formed from two or more things",
    "Being the same size as its surrounding part",
    "Someone who studies space",
    "How big or small something is",
    "Longer and thinner than usual",
    "Between the stars",
    "Part of a single star",
    "To stop something before it reaches a particular point",
    "Two or more things combine or join",
    "To fall down or towards the inside",
    "Comparing two or more objects",
    "A lot of things close together",
    "To use up something",
    "To fill or be present in",
    "To cause something to be produced or to exist",
    "A lot available",
    "Extremely large",
...
var Quiz2QuestionPromptTexts = [
    ...
    "Earth's atmostphere has an ozone layer. __________, ultraviolet radiation cannot reach the Earth's surface.",
    "_________ black holes, nothing can escape.",
    "Supermassive black holes exist in outerspace ___________ radiation that is emitted as dust and gas.",
    "irregular",
    "rift",
    "feature",
    "collapse",
...
var AssertionTexts = [
    ...
    "elongated refers to something that is longer or thinner than usual. Elliptical galaxies may be circular or so thin that they look like a cigar!",
    ...
    "The word relatively can mean comparing two or more objects. Black holes formed by the collapse of individual stars are very small. So relatively small means that compared to other things around it that are larger, it is very small.",
    ...
    "The word observational. Observational refers to the something is carefully watched and learned from. If scientists cannot see black holes they cannot learn from them.",
...
player.GetVar("StudentUnderstand");
    ...
    player.SetVar("Assertion", AssertionTexts[slidenumber - 1]);
console.log("Setting Assertion to: " + AssertionTexts[slidenumber - 1]);
player.SetVar("BlankPrompt", BlankPromptTexts[slidenumber - 1]);
console.log("Setting BlankPrompt to: " + BlankPromptTexts[slidenumber - 1]);
player.SetVar("Correct", CorrectTexts[slidenumber - 1]);
console.log("Setting Correct to: " + CorrectTexts[slidenumber - 1]);
player.SetVar("IncorrectPrompt", IncorrectPromptTexts[slidenumber - 1]);
console.log("Setting IncorrectPrompt to: " + IncorrectPromptTexts[slidenumber - 1]);
player.SetVar("StudentAgree", StudentAgreeTexts[slidenumber - 1]);
console.log("Setting StudentAgree to: " + StudentAgreeTexts[slidenumber - 1]);
player.SetVar("StudentAnswerAgree", StudentAnswerAgreeTexts[slidenumber - 1]);
console.log("Setting StudentAnswerAgree to: " + StudentAnswerAgreeTexts[slidenumber - 1]);
player.SetVar("StudentAnswerUnderstand", StudentAnswerUnderstandTexts[slidenumber - 1]);
console.log("Setting StudentAnswerUnderstand to: " + StudentAnswerUnderstandTexts[slidenumber - 1]);
player.SetVar("StudentDisagree", StudentDisagreeTexts[slidenumber - 1]);
console.log("Setting StudentDisagree to: " + StudentDisagreeTexts[slidenumber - 1]);
player.SetVar("StudentUnderstand", StudentUnderstandTexts[slidenumber - 1]);
console.log("Setting StudentUnderstand to: " + StudentUnderstandTexts[slidenumber - 1]);

    var AssertionDuration = calculateDuration(AssertionTexts[slidenumber - 1]);
var BlankPromptDuration = calculateDuration(BlankPromptTexts[slidenumber - 1]);
var CorrectDuration = calculateDuration(CorrectTexts[slidenumber - 1]);
var IncorrectPromptDuration = calculateDuration(IncorrectPromptTexts[slidenumber - 1]);
var StudentAgreeDuration = calculateDuration(StudentAgreeTexts[slidenumber - 1]);
var StudentAnswerAgreeDuration = calculateDuration(StudentAnswerAgreeTexts[slidenumber - 1]);
var StudentAnswerUnderstandDuration = calculateDuration(StudentAnswerUnderstandTexts[slidenumber - 1]);
var StudentDisagreeDuration = calculateDuration(StudentDisagreeTexts[slidenumber - 1]);
var StudentUnderstandDuration = calculateDuration(StudentUnderstandTexts[slidenumber - 1]);
