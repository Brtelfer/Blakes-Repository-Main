function setTexts(slidenumber) {
    ...
    var incorrectPromptTexts = [
        ...
        "A good thing to consider for this question is what do the other skills have in common. How will they relate to his objective? Let's give it one more try. Which does not fit? Choose one of the highlighted answers.",
    ...
    var questionPromptTexts = [
        ...
        "Which of the highlighted dates shows the purchase Student spent the most on this month?",
        ...
        "Click on the highlighted section that best reflects Student's goals.",
        "Which email will be the easiest for people to remember and also look professional?",
        "In which of the highlighted sections would Student most likely include his exposure to graphic design?",
        "Which highlighted bullet point under Core Qualifications does not fit with Student's other skills?",
    ...
    var correctDurationHalf = Math.floor(correctFullDuration + 3);
    var incorrectPromptDurationHalf = Math.floor(incorrectPromptFullDuration + 3);
    var studentUnderstandDurationHalf = Math.floor(studentUnderstandFullDuration + 3);
